<template>
  <div class="common-layout">
    <el-container>
      <el-header>
        <div class="header_title">xxxxx导航平台</div>
        <div style="width: calc(100vw - 600px);">
          <div style="margin-top: 30px">
            <el-image style="width: 101px; height: 33px;position: relative;top:8px;right: 10px"
                      :src="'https://www.baidu.com/img/flexible/logo/pc/result.png'"/>
            <el-form target="_blank" style="display: inline" action="https://www.baidu.com/s">
              <el-input style="width: calc(100% - 121px);" v-model="keywords" name=wd>
                <template #append>
                  <el-button :icon="'Search'" native-type="submit" placeholder="百度一下" />
                </template>
              </el-input>
            </el-form>
          </div>
        ...
        <div class="header_button">
          <el-button type="primary" link>首页</el-button>
          <el-button type="primary" link>关于我们</el-button>
      ...
      <el-container style="height: calc(100vh - 120px)">
        <el-aside width="200px">
          <el-menu default-active="0-0">
            <el-sub-menu :index="index+''" v-for="(item,index) in menus" :key="index">
              <template #title>
                <component style="width: 20px;height: 20px;padding-right: 10px;" :is="item.icon"></component>
                <span>{{item.menuName}}</span>
              </template>
              <el-menu-item-group :title="itemChild.desc" v-for="(itemChild,itemChildIndex) in item.menuList" :key="itemChildIndex">
                <el-menu-item :index="index + '-' + itemChildIndex" style="height: auto;padding-left: 20px">
                  <div style="display: flex;flex-wrap: wrap;">
                    <el-tag v-for="(tag,tagIndex) in itemChild.childList"
                            :key="tagIndex"
                            :title="tag.name"
                            style="min-width: calc(50% - 10px);margin: 5px">
                      {{tag.name}}</el-tag>
                  </div>
                </el-menu-item>
              </el-menu-item-group>
        ...
        <el-main>
          ...
          <el-descriptions>
            <template #title>
              <el-image style="width: 120px;float: left" :src="'https://js.ckeke.com/dwm/images/logo.gif'"></el-image>
              <el-rate style="float: right" v-model="value1" />
            </template>
            <el-descriptions-item label="网站名称">风车动漫</el-descriptions-item>
            <el-descriptions-item label="类别标签">
          ...
          <el-descriptions>
            <template #title>
              <el-image style="width: 120px;float: left;background-color: #000" :src="'http://age456.com/templets/feifan123/images/logo.png'"></el-image>
              <el-rate style="float: right" v-model="value1" />
            </template>
            <el-descriptions-item label="网站名称">风车动漫</el-descriptions-item>
            <el-descriptions-item label="类别标签">
          ...
          <el-descriptions>
            <template #title>
              <el-image style="width: 120px;float: left" :src="'https://ali-imgs.acfun.cn/kos/nlav10360/static/common/widget/header/img/logo.1630669e02c65e87236f.svg'"></el-image>
              <el-rate style="float: right" v-model="value1" />
            </template>
            <el-descriptions-item label="网站名称">风车动漫</el-descriptions-item>
            <el-descriptions-item label="类别标签">
